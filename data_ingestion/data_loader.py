...
class Data_Getter:
    ...
    def get_boston_data(self):
        ...
        """
        self.training_file=load_boston()

        self.logger_object.log(self.file_object,'Entered the get_data method of the Data_Getter class')
        try:
            self.data= pd.DataFrame(self.training_file.data, columns=self.boston.feature_names) # reading the data file
